function create_boundaries(spr_width, spr_height, rm_width = room_width, rm_height = room_height, x_pos = 0, y_pos = 0) {
	// Top boundary
    var top_boundary = instance_create_layer(x_pos, y_pos, "Instances", obj_boundary);
    ...
    // Bottom boundary
    var bottom_boundary = instance_create_layer(x_pos, rm_height, "Instances", obj_boundary);
    ...
    // Right boundary
    var right_boundary = instance_create_layer(rm_width, y_pos, "Instances", obj_boundary);
    ...
    // Left boundary
    var left_boundary = instance_create_layer(x_pos, y_pos, "Instances", obj_boundary);
